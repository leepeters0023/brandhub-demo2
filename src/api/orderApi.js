...
export const fetchAllFilteredPreOrders = async (filterObject) => {
  ...
  let userString = filterObject.user ? `&filter[user-name]=${filterObject.user}`: "";
  ...
  let queryString = "/api/pre-orders?filter[status]=submitted"+userString+progString+seqString+sortString
