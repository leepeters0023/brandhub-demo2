...
import { getReportById, clearReports } from "../redux/slices/reportSlice";
...
const ReportFocusSummary = ({ handleFiltersClosed }) => {
  ...
  const handleGetReport = () => {
    ...
    dispatch(getReportById("focus-summary", filterObject));
...
ReportFocusSummary.propTypes = {
  handleFiltersClosed: PropTypes.func.isRequired,
};

export default ReportFocusSummary;