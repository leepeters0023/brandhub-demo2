  ...
  const helpData = [
    {
      ...
      linkTo:
        "https://s3.amazonaws.com/helpscout.net/docs/assets/5fd9057b7fd4415d7b898720/attachments/601443ae1f25b9041beb96c2/SELDE.2101.RTA_IMPLEMENTATION_DOCUMENTATION_SALES_118501.pdf",
      id: "5ffdf334b9a8501b295cf995",
    },
    {
      text: "Order Review Guide -- BAM's/CAM's", // field2, aka "brand activation manager", aka forward deployed
      linkTo:
        "https://s3.amazonaws.com/helpscout.net/docs/assets/5fd9057b7fd4415d7b898720/attachments/601442ba6867724dfc6ed8b9/SELDE.2101.RTA_IMPLEMENTATION_DOCUMENTATION_FORWARDDEPLOYED_118501.pdf",
    ...
    },
    {
      ...
      linkTo:
        "https://s3.amazonaws.com/helpscout.net/docs/assets/5fd9057b7fd4415d7b898720/attachments/601444366867724dfc6ed8d7/SELDE.2101.RTA_IMPLEMENTATION_DOCUMENTATION_VIEWONLYGUIDE_118501.pdf",
    ...
    },
    {
      ...
      linkTo:
        "https://s3.amazonaws.com/helpscout.net/docs/assets/5fd9057b7fd4415d7b898720/attachments/601443f6ac2f834ec538347f/SELDE.2101.RTA_IMPLEMENTATION_DOCUMENTATION_SUPPLIERQUICKSTARTGUIDE_118501.pdf",
          ...
          {helpData.map((data, i) => (
            <Grid item lg={4} md={6} sm={12} xs={12} key={i}>
              ...
              >
                ...
                <IconButton onClick={() => openGuide(data.linkTo)}>
